%% ImageErode
% 
%  Perform a morphology erosion on an input image with 4- or 8- connectivity structuring element
% 
function ImageErode(block)
...
switch Select48
    case 1
        block.OutputPort(1).Data = imerode(sigVal,Connectivity4);
    case 2
        block.OutputPort(1).Data = imerode(sigVal,Connectivity8);
end
%endfunction
