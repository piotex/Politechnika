%% AddShoot
% 
%  Adds to input image a shoot noise (salt & pepper) with density from parameter
% 
function AddShoot(block)
...
Density = block.DialogPrm(1).Data;
%endfunction
...
block.OutputPort(1).Data = imnoise(sigVal,'salt & pepper',Density/100);
%endfunction
