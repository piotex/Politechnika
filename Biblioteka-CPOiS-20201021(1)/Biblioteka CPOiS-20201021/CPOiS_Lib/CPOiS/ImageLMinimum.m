%% ImageLMinimum
% 
%  Performs local minimum filtering of the input image in two dimensions
% 
function ImageLMinimum(block)
...
block.OutputPort(1).Data = uint8(ordfilt2(sigVal,1,ones(Dimension)));
%endfunction
