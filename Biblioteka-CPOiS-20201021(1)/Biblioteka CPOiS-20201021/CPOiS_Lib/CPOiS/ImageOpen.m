%% ImageOpen
% 
%  Perform a morphological opening on an input image with 4- or 8- connectivity structuring element
% 
function ImageOpen(block)
...
switch Select48
    case 1
        block.OutputPort(1).Data = imopen(sigVal,Connectivity4);
    case 2
        block.OutputPort(1).Data = imopen(sigVal,Connectivity8);
end
%endfunction
