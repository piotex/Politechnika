%% AddGaussian
% 
%  Adds to input image a Gaussian white noise with mean and variance from parameters
% 
function AddGaussian(block)
...
Mean = block.DialogPrm(1).Data;
Variance = block.DialogPrm(2).Data;
%endfunction
...
block.OutputPort(1).Data = imnoise(sigVal,'gaussian',Mean/255,Variance/255);
%endfunction
