%% ImageClose
% 
%  Perform a morphological closing on an input image with 4- or 8- connectivity structuring element
% 
function ImageClose(block)
...
switch Select48
    case 1
        block.OutputPort(1).Data = imclose(sigVal,Connectivity4);
    case 2
        block.OutputPort(1).Data = imclose(sigVal,Connectivity8);
end
%endfunction
